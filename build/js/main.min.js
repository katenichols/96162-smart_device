...
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! exports provided: footerTitles, footerNavList, footerContactsList, arr */
...
var arr = Array.from(footerTitles); // ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  footerContactsList.classList.add('is-close'); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  ...
  window.addEventListener('load', function () {
    ...
    var _loop = function _loop(i) {
      arr[i].addEventListener('click', function () {
        Object(_modules_on_footer_title_click__WEBPACK_IMPORTED_MODULE_2__["onFooterTitleClick"])(arr[i]);
      });
    };
...
var onFooterTitleClick = function onFooterTitleClick(el) {
  if (el === _main__WEBPACK_IMPORTED_MODULE_0__["arr"][0] && el.classList.contains('is-close') && _main__WEBPACK_IMPORTED_MODULE_0__["arr"][1].classList.contains('is-close')) {
  ...
  if (el === _main__WEBPACK_IMPORTED_MODULE_0__["arr"][1] && el.classList.contains('is-close') && _main__WEBPACK_IMPORTED_MODULE_0__["arr"][0].classList.contains('is-close')) {
    el.classList.remove('is-close');
    el.classList.add('is-open');
  ...
  if (el === _main__WEBPACK_IMPORTED_MODULE_0__["arr"][0] && el.classList.contains('is-close') && _main__WEBPACK_IMPORTED_MODULE_0__["arr"][1].classList.contains('is-open')) {
    el.classList.remove('is-close');
    el.classList.add('is-open');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerNavList"].classList.remove('is-close');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerNavList"].classList.add('is-open');
    _main__WEBPACK_IMPORTED_MODULE_0__["arr"][1].classList.remove('is-open');
    _main__WEBPACK_IMPORTED_MODULE_0__["arr"][1].classList.add('is-close');
  ...
  if (el === _main__WEBPACK_IMPORTED_MODULE_0__["arr"][0] && el.classList.contains('is-open') && _main__WEBPACK_IMPORTED_MODULE_0__["arr"][1].classList.contains('is-close')) {
    ...
    _main__WEBPACK_IMPORTED_MODULE_0__["arr"][1].classList.remove('is-close');
    _main__WEBPACK_IMPORTED_MODULE_0__["arr"][1].classList.add('is-open');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerContactsList"].classList.remove('is-close');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerContactsList"].classList.add('is-open');
    return;
  }

  if (el === _main__WEBPACK_IMPORTED_MODULE_0__["arr"][1] && el.classList.contains('is-open') && _main__WEBPACK_IMPORTED_MODULE_0__["arr"][0].classList.contains('is-close')) {
    el.classList.remove('is-open');
    el.classList.add('is-close');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerContactsList"].classList.remove('is-open');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerContactsList"].classList.add('is-close');
    _main__WEBPACK_IMPORTED_MODULE_0__["arr"][0].classList.remove('is-close');
    _main__WEBPACK_IMPORTED_MODULE_0__["arr"][0].classList.add('is-open');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerNavList"].classList.remove('is-close');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerNavList"].classList.add('is-open');
    return;
  }

  if (el === _main__WEBPACK_IMPORTED_MODULE_0__["arr"][1] && el.classList.contains('is-close') && _main__WEBPACK_IMPORTED_MODULE_0__["arr"][0].classList.contains('is-open')) {
    el.classList.remove('is-close');
    el.classList.add('is-open');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerContactsList"].classList.remove('is-close');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerContactsList"].classList.add('is-open');
    _main__WEBPACK_IMPORTED_MODULE_0__["arr"][0].classList.remove('is-open');
    _main__WEBPACK_IMPORTED_MODULE_0__["arr"][0].classList.add('is-close');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerNavList"].classList.remove('is-open');
    _main__WEBPACK_IMPORTED_MODULE_0__["footerNavList"].classList.add('is-close');
    return;
  } // switch (el) {
